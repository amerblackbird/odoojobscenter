            ...
            <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <motion.div initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.6}}>
                        <Badge
                            className="bg-white text-gray-600 mb-8 rounded-full px-4 py-2 shadow-sm border border-gray-100">
                            {t('comprehensiveItSolutions')}
                        </Badge>
                    </motion.div>
                    ...
                    >
                        {t('our')}
                        <span
                            className="text-transparent bg-clip-text bg-gradient-to-r rtl:bg-gradient-to-l from-primary-600 to-red-300">
              {" "}
                            {t('services')}
            </span>
                    </motion.h1>
