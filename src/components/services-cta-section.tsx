                ...
                >
                    <Card className="border-0 bg-gradient-to-r from-primary-600 to-secondary-600 rounded-3xl">
                        <CardContent className="p-12 text-white text-center">
                            <h2 className="text-3xl font-bold mb-6">{t("servicesCtaHeadline")}</h2>
                            <p className="text-primary-100 mb-8 max-w-2xl mx-auto text-lg leading-relaxed">
                                {t("servicesCtaDescription")}
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <Button size="lg"
                                        className="bg-white text-primary-600 hover:bg-gray-100 rounded-xl px-8 py-4">
                                    {t("servicesCtaScheduleButton")}
                                ...
                                >
                                    {t("servicesCtaViewCaseStudiesButton")}
